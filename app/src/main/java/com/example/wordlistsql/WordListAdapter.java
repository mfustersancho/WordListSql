...
public class WordListAdapter extends RecyclerView.Adapter<WordListAdapter.WordViewHolder> {
     ...
     */
    private WordListAdapter me = this;
    ...
    public void onBindViewHolder(WordViewHolder holder, int position) {
        ...
        holder.delete_button.setOnClickListener(new MyButtonOnClickListener(current.getId(), current.getWord(), current.getDefinition()) {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(mContext);
                builder.setCancelable(true);
                builder.setTitle("Delete a word");
        ...
        holder.edit_button.setOnClickListener(new MyButtonOnClickListener(current.getId(), current.getWord(), current.getDefinition()) {
            @Override
            public void onClick(View v) {
